...
const statements = [
  { text: "BURN BRIGHT", color: "text-gradient-warm" },
  { text: "CREATE WILDLY", color: "text-gradient-pink" },
  { text: "LOVE DEEPLY", color: "text-gradient-golden" },
  { text: "BUILD TOGETHER", color: "text-gradient-warm" },
  { text: "LEAVE NOTHING", color: "text-gradient-pink" },
  { text: "REMEMBER EVERYTHING", color: "text-gradient-golden" },
      ...
      <div className="relative">
        {statements.map((statement, i) => (
          <KineticStatement
            ...
            index={i}
            hasBrand={"hasBrand" in statement}
          />
        ))}
      </div>
          ...
          {[
            {
              ...
              desc: "Everyone is welcome. No prerequisites, no gatekeeping.",
            },
            {
              title: "Gifting",
              desc: "We give freely. Time, talent, art — no strings attached.",
            },
            {
              title: "Leave No Trace",
              desc: "We respect the land. What we bring in, we take out.",
            },
            {
              title: "Communal Effort",
              desc: "Every member contributes. Together we build the impossible.",
            },
          ].map((value, i) => (
            <motion.div
              key={value.title}
