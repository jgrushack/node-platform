  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <section className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        >
          <p>A collective of creators, builders, and dreamers.</p>
      ...
      <section className="px-6 pb-32">
        <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-3">
          {[
            {
              title: "Create",
              desc: "Art, music, installations — express yourself without limits.",
              gradient: "from-pink-500/20 to-orange/20",
            },
            {
              title: "Connect",
              desc: "Form bonds that transcend the playa and last a lifetime.",
              gradient: "from-amber/20 to-golden/20",
            },
            {
              title: "Contribute",
              desc: "Everyone has a role. Everyone matters. Radical participation.",
