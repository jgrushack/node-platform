...
const ALLOWED_REDIRECTS = ["/dashboard", "/dashboard/profile", "/dashboard/payments", "/dashboard/members", "/dashboard/calendar", "/dashboard/applications", "/dashboard/reports", "/dashboard/users", "/dashboard/messages"];
