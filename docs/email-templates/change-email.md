...
**Subject:** `Confirm Your New Email — NODE`
...
<head>
  ...
  <title>Confirm Your New Email — NODE</title>
          ...
          <tr>
            <td style="padding:40px 32px;background-color:#1a0a2e;border:1px solid rgba(249,0,119,0.2);border-bottom:none;">
              ...
              <p style="margin:0 0 20px;font-size:16px;line-height:1.7;color:#F9EDD8;">
                You requested to change the email address on your NODE account. Click below to confirm your new email.
              </p>
              <p style="margin:0 0 40px;font-size:14px;line-height:1.7;color:#F9EDD8;opacity:0.6;">
                If you didn't request this change, you can safely ignore this email. Your account will remain unchanged.
              </p>
              <!-- CTA Button -->
                ...
                <tr>
                  <td align="center">
                    <a href="{{ .ConfirmationURL }}" target="_blank" style="text-decoration:none;">
                      <img src="https://www.node.family/images/email-button-email-change.png" alt="Confirm Email Change" width="300" height="52" style="display:block;border-radius:12px;" />
                    </a>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:32px;background-color:#0F0120;border-top:1px solid rgba(249,0,119,0.3);border-radius:0 0 16px 16px;">
              ...
              <p style="margin:0;font-size:12px;color:#F9EDD8;text-align:center;opacity:0.4;line-height:1.6;">
                You're receiving this because an email change was requested on your NODE account.
              </p>
            </td>
          </tr>
        </table>
